...
<html>
    <head>
        ...
        <title>View Multi Choice 3 Answers</title>
        ...
        <style type="text/css">
            table { float: left; margin: 160px 70px 0px 50px;  }
            ...
            .webUser_gen_toolbar7{border: 1px solid white;padding: 2em;-moz-border-radius: 3px;width:335px;margin:auto;margin-bottom: 0px;margin-top: 20px;background: #cdcdcd;}
